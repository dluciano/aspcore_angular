...
namespace Arch.IS4Host
{
    public class Startup
    {
        ...
        private void InitializeDatabase(IApplicationBuilder app)
        {
            ...
            {
                var persistenceGrantDbContext = serviceScope.ServiceProvider.GetService<PersistedGrantDbContext>();
                persistenceGrantDbContext.Database.Migrate();
                ...
                if (!configurationDbContext.ApiResources.Any())
                {
                    ...
                    {
                        configurationDbContext.Add(api.ToEntity());
                    }
